...
from env_config import get_base_path, can_write, can_edit_tags, get_user_role, has_any_access
            ...
            try:
                if action == "add":
                    ...
                    if not name:
                        ...
                        existing = db_ops.get_non_segmentation_tags() or []
                        exists = any(
                    ...
                    if not tag_id.isdigit():
                        ...
                        if not ok:
                            messages.append(("danger", "Cannot delete tag (likely has associated values)"))
                        else:
